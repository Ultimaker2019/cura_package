...
cmake -DCMAKE_INSTALL_PREFIX=%INSTALL_PATH% -G"NMake Makefiles" -DCMAKE_BUILD_TYPE=Release -DBUILD_STATIC=ON -DBUILD_PYTHON=ON -DMSVC_STATIC_RUNTIME=ON -Wno-dev %SRC_PATH%/libArcus
nmake
nmake install
