...
cd %BUILD_PATH%\zlib
cmake -DCMAKE_INSTALL_PREFIX=%INSTALL_PATH% -G"NMake Makefiles" -DCMAKE_BUILD_TYPE=Release %SRC_PATH%/zlib
nmake
nmake install
...
cmake -DCMAKE_INSTALL_PREFIX=%INSTALL_PATH% -G"NMake Makefiles" -DCMAKE_BUILD_TYPE=Release -Wno-dev -Dprotobuf_BUILD_TESTS=OFF %SRC_PATH%/protobuf/cmake
nmake
nmake install
