...
cmake -DCMAKE_INSTALL_PREFIX=%INSTALL_PATH% -G"MinGW Makefiles" -DCMAKE_BUILD_TYPE=Release -DBUILD_STATIC=ON -DBUILD_PYTHON=OFF -DMSVC_STATIC_RUNTIME=OFF -Wno-dev %SRC_PATH%/libArcus
mingw32-make
