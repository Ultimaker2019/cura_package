...
pip3 install %SOFTWARE_PATH%\python\%PYTHON_VERSION%\32bit\Shapely-1.7.1-cp37-cp37m-win32.whl
pip3 install %SOFTWARE_PATH%\python\%PYTHON_VERSION%\32bit\numpy-1.19.2+mkl-cp37-cp37m-win32.whl
pip3 install %SOFTWARE_PATH%\python\%PYTHON_VERSION%\32bit\scipy-1.4.1-cp37-cp37m-win32.whl
